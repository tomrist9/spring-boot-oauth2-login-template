...
* The original package name 'com.walletwave.spring-boot-oauth2-login-template' is invalid and this project uses 'com.walletwave.spring_boot_oauth2_login_template' instead.
